...
Carga y descarga las dependencias insmod no  
...
Mostrar a partir del tercer campo del archivo /etc/passwd
Mostrar el nombre, home y shell del /etc/passwd
Mostrar el contenido del /etc/passwd sustituyendo : por " "