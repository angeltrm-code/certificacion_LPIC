...
##Instalariamos este paquete en linux para tener soporte de ntfs en nuestra maquina
Fecha de modificacion del archivo /etc/passwd
Buscar archivos desde el / modificados hace menos de 24 horas
Buscar archivos desde el / con un tamaño superior a 200M
...
Tamaño ocupado de la particion /
...
arrancat ahora el servicio httpd  systemd y sistemv
Comando para ver en systend el target actual y en systemv
Comando para moverme en calient entre en targe o runlevel 5 en systemd systemv
