...
## Excluir los paquetes del kernel de la actualizacion de yum
...
Tarea programada en el cron para el script /opt/supervisamem todos los dias a las 15 horas y que su salida (stdout,stderr) no la envie por correo
