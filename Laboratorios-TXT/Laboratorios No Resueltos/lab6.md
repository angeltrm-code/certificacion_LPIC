...
## Que tipo de particiones es 83 82 8e

## Comando para arrancar el servicio httpd en systemv y systemd

## Como cambiamos de runlevel o target en systemv y systemd al runlevel 3

## Cambiar al runlevel o target 1 en systemv y en systemd

## Poner al inicio el servicio httpd en systemv y systemd
