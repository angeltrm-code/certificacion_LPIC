...
Comando para averiguar el directorio actual
Eliminar el directorio /a y su contenido
Copiar los archivos del directorio /etc que el segundo caracter sea una h en el directorio /b
cp /etc/
...
Buscar archivos con extendion avi en el directorio /videos y borrarlos en la misma orden
...
Permiso permiso Sticky Bit al directorio /datos
