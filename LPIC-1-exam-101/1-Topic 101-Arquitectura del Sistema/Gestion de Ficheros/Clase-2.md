...
Cuando el permiso de identificación de usuario (setuid) esta asignado sobre un fichero
ejecutable, un usuario o proceso que lo ejecuta tiene garantizado el acceso como
...
El comando ldd permite determinar cuales son las librerías vinculadas a un programa y
también si están persistentes o no
ldd /usr/sbin/fsck
