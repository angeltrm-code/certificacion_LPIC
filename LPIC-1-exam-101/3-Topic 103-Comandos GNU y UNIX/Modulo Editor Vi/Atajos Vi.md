...
Documento de referencia sobre Atajos vi con formato Markdown homogéneo y navegación más clara.

## Editor Vi

vi es un editor de texto en modo consola, muy ligero y presente en prácticamente cualquier sistema Unix/Linux.

En muchos sistemas modernos, vi es en realidad un enlace a vim (Vi IMproved).
...
1G   A la primera línea  del documento
```
...
Las cadenas especificadas no pueden tener caracteres especiales como *,?,$,etc., a no ser que esté activada la opción set nomagic. La busqueda es 'case-sensitive' a no ser que esté activada la opción set ignorecase
...
dirección indica sobre qué parte del documento se realizan los cambios. g es opcional e indica si el cambio debe tener efecto una sola vez en cada línea o todas las veces (si fuese el caso) c es opcional e indica que se pida confirmación para que el cambio tenga efecto
